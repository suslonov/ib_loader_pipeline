...
#python $1/history_data_updater.py $2/download_options_minute
...
python $1/history_data_updater.py $2/download_options_minute4 &
python $1/history_data_updater.py $2/download_options_minute5 &
python $1/history_data_updater.py $2/download_options_minute6 &
